...
export const HOME_TESTIMONIALS = [
  { deity: "黃財神", text: "原本卡住的資金順利到位，不穩定的收支逐漸平衡，心也定了。更神奇的是，接到一筆大額訂單。", location: "台北市", occupation: "創業主", name: "張先生" },
  { deity: "大吉祥天女", text: "財庫的漏洞彷彿被補上了，無謂的意外開銷明顯減少。存款終於能累積。", location: "台中市", occupation: "經理", name: "林小姐" },
  { deity: "象頭財神", text: "點燈護持後，思緒變得異常清晰。順利避開了一個有問題的合夥案。", location: "新竹縣", occupation: "工程師", name: "吳先生" },
  { deity: "作明佛母", text: "原本冷戰的僵局化解，感受到久違的被重視與溫暖。感情順利修復。", location: "高雄市", occupation: "行銷", name: "陳小姐" },
  { deity: "綠度母", text: "報名火供後，壓在胸口的重擔感消失了，整個人重新找回了踏實的安全感。", location: "新北市", occupation: "設計師", name: "郭小姐" }
];
...
export interface Deity {
  ...
  readonly scripture: { quote: string; source: string }[];
  readonly painPoints: string[];
  readonly whyThisDeity: string[];
  readonly process: { title: string; body: string }[];
...
export const DEITY_BY_KEY: Record<DeityKey, Deity> = {
  ...
  "ganapati": {
    ...
    scripture: [{ quote: "「持誦此咒，我當隨逐... 百由旬內，無有眾難，令所作皆成。」", source: "《大聖歡喜天陀羅尼》" }],
  ...
  "kurukulla": {
    ...
    scripture: [{ quote: "「攝受眾生心識，令彼生歡喜心、敬愛心，轉違緣為善緣。」", source: "《作明佛母儀軌傳承》" }],
  ...
  "green-tara": {
    ...
    scripture: [{ quote: "「嗡！敬禮聖度母... 迅捷勇悍度母，眼如閃電剎那光。」", source: "《二十一尊度母讚》" }],
