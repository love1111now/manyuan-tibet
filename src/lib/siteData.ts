 ...
 * 100% 完整無省略版：精確對齊 Home, Deity, Sutra, Topic, Pay, Proof 等所有組件
 */
...
export const DEITY_BY_KEY: Record<DeityKey, Deity> = {
  "yellow": {
    ...
    plans: [
      { id: "y1", name: "智慧明燈", price: "NT$ 490", blurb: "照破貧窮幽暗，對治慳吝業障。", url: "https://cart.cashier.ecpay.com.tw/qp/z4W0", suitableFor: ["小額發心", "新手入門"], details: ["如法供燈乙對", "壇城名單回向"] },
      { id: "y2", name: "如意水供", price: "NT$ 980", blurb: "清淨匱乏耗損，資糧如水盈滿。", url: "https://cart.cashier.ecpay.com.tw/qp/z4XF", hot: true, badge: "最速增益", suitableFor: ["急需資金", "業績卡關"], details: ["連續水供儀軌", "專屬名單回向"] },
      { id: "y3", name: "除障香供", price: "NT$ 1,860", blurb: "淨化事業違緣，穩固財富磁場。", url: "https://cart.cashier.ecpay.com.tw/qp/z4Y3", suitableFor: ["事業擴張", "避開風險"], details: ["特製除障香供", "加強名單回向"] },
      { id: "y4", name: "增益薈供", price: "NT$ 3,680", blurb: "大乘福德總集，成就圓滿緣起。", url: "https://cart.cashier.ecpay.com.tw/qp/z4Z5", suitableFor: ["重大企劃", "總體增益"], details: ["廣大薈供儀軌", "數位回向證明"] }
    ],
    faq: [
      { q: "護持後需要特別做什麼嗎？", a: "建議多行小額布施，能與黃財神的加持能量產生強大共鳴。" }, 
      { q: "一定要每天做嗎？", a: "本法事由現場代為執行，您只需保持清淨發心即可。" }
    ],
    crossSell: [
  ...
  "mahashri": {
    ...
    plans: [
      { id: "m1", name: "吉祥明燈", price: "NT$ 490", blurb: "照破貧窮幽暗，迎來吉祥之光。", url: "https://cart.cashier.ecpay.com.tw/qp/z4ND", suitableFor: ["小額發心"], details: ["吉祥供燈乙對", "壇城名單回向"] },
      { id: "m2", name: "豐饒水供", price: "NT$ 980", blurb: "洗滌耗損福報之業，安立豐足磁場。", url: "https://cart.cashier.ecpay.com.tw/qp/z4PD", hot: true, badge: "豐足首選", suitableFor: ["意外破財", "家宅不寧"], details: ["清淨水供儀軌", "家宅平安回向"] },
      { id: "m3", name: "清淨香供", price: "NT$ 1,860", blurb: "化解生存危機感，以妙香安立於豐足磁場中。", url: "https://cart.cashier.ecpay.com.tw/qp/z4Q7", suitableFor: ["家宅安靜"], details: ["特製清淨香", "家宅名單回向"] },
      { id: "m4", name: "滿願薈供", price: "NT$ 3,680", blurb: "廣聚善緣福德，護佑所求願滿。", url: "https://cart.cashier.ecpay.com.tw/qp/z4V8", suitableFor: ["重大祈願"], details: ["豐饒大薈供", "數位回向證明"] }
    ],
    faq: [
      { q: "可以回向給全家人嗎？", a: "是的，一份護持方案可回向給全家室長與眷屬。" },
      { q: "適合祈求事業嗎？", a: "天女較偏向『守護現有資產與平安』，若需擴張事業建議搭配黃財神。" }
    ],
    crossSell: [
  ...
  "ganapati": {
    ...
    plans: [
      { id: "g1", name: "清明燈供", price: "NT$ 490", blurb: "照破愚痴與無明迷霧。", url: "https://cart.cashier.ecpay.com.tw/qp/z4R5", suitableFor: ["小額發心"], details: ["清明供燈乙對"] },
      { id: "g2", name: "平息水供", price: "NT$ 980", blurb: "洗滌身心焦慮，平息職場干擾。", url: "https://cart.cashier.ecpay.com.tw/qp/z4S8", hot: true, badge: "破迷必備", suitableFor: ["職場壓力", "面臨抉擇"], details: ["除障水供儀軌", "智慧決策回向"] },
      { id: "g3", name: "破障香供", price: "NT$ 1,860", blurb: "強力掃除障礙。", url: "https://cart.cashier.ecpay.com.tw/qp/z4T1", suitableFor: ["重大談判"], details: ["特製破障香", "決策無礙回向"] },
      { id: "g4", name: "成就薈供", price: "NT$ 3,680", blurb: "總集威德加持，無礙成辦善業。", url: "https://cart.cashier.ecpay.com.tw/qp/z4U2", suitableFor: ["談判競標", "事業突破"], details: ["成就大薈供", "數位回向證明"] }
    ],
    faq: [
      { q: "適合求偏財嗎？", a: "象神助您提升的是判斷智慧，當判斷正確，財路自然通達。" },
      { q: "遇到小人可以護持嗎？", a: "非常適合，象神能強力掃除外在與隱蔽的違緣干擾。" }
    ],
    crossSell: [
      { title: "若你急需突破現狀，大幅增加現金收入", desc: "看黃財神：主動出擊，強效開源與止漏。", to: "yellow" },
      { title: "若你感到莫名焦慮，或是生活阻力重重", desc: "看綠度母：迅疾救護，掃除八難與突發怖畏。", to: "green-tara" }
  ...
  "kurukulla": {
    ...
    plans: [
      { id: "k1", name: "懷愛明燈", price: "NT$ 490", blurb: "點燃懷攝之光。", url: "https://cart.cashier.ecpay.com.tw/qp/z5a8", suitableFor: ["小額發心"], details: ["懷愛供燈乙對"] },
      { id: "k2", name: "攝受花供", price: "NT$ 980", blurb: "修復情感裂痕，增長個人魅力。", url: "https://cart.cashier.ecpay.com.tw/qp/z5bF", hot: true, badge: "懷愛首選", suitableFor: ["單身求緣", "感情失和"], details: ["莊嚴花供儀軌", "情感圓滿回向"] },
      { id: "k3", name: "淨緣香供", price: "NT$ 1,860", blurb: "淨化情執惡緣。", url: "https://cart.cashier.ecpay.com.tw/qp/z5c3", suitableFor: ["切斷孽緣"], details: ["特製淨緣香", "磁場修復回向"] },
      { id: "k4", name: "自在薈供", price: "NT$ 3,680", blurb: "懷業總集。令眾生見者歡喜。", url: "https://cart.cashier.ecpay.com.tw/qp/z5d7", suitableFor: ["公關推廣", "權勢地位"], details: ["自在懷業薈供", "數位回向證明"] }
    ],
    faq: [
      { q: "可以用於輓回特定對象嗎？", a: "佛母能量首重善緣與自省，若雙方仍有緣份，祂會修復阻礙。" },
      { q: "工作需要好人緣適合嗎？", a: "非常適合，懷攝法門能讓您在職場中更容易獲得信任與支援。" }
    ],
    crossSell: [
  ...
  "green-tara": {
    ...
    plans: [
      { id: "t1", name: "慈悲明燈", price: "NT$ 680", blurb: "度母救八難，照亮諸事晦暗與不安。", url: "https://cart.cashier.ecpay.com.tw/qp/zEJ1", suitableFor: ["日常祈福", "心神不寧"], details: ["慈悲供燈乙對"] },
      { id: "t2", name: "救護薈供", price: "NT$ 1,280", blurb: "度脫一切苦厄，令身心輕安。", url: "https://cart.cashier.ecpay.com.tw/qp/zED7", hot: true, badge: "全方位守護", suitableFor: ["身心疲累", "運勢低迷"], details: ["深度除障儀軌", "救護加持回向"] }
    ],
    faq: [
      { q: "為什麼稱為迅疾？", a: "度母右足下垂，象徵隨時準備起身救度，加持反應極快。" },
      { q: "遇到官司或糾紛適合嗎？", a: "適合，度母能有效平息外在的突發災厄與人為糾紛。" }
    ],
    crossSell: [
      { title: "若你急需突破現狀，大幅增加現金收入", desc: "看黃財神：主動出擊，強效開源與止漏。", to: "yellow" },
      { title: "若你覺得夫妻感情變淡，或是人際關係耗損", desc: "看作明佛母：重新引爆懷愛磁場，找回溫暖羈絆。", to: "kurukulla" }
