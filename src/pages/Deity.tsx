...
import deityImg1 from "@/assets/visuals/seo/image_w5504_h3072_page-deity-1.webp";
import deityImg2 from "@/assets/visuals/seo/image_w5504_h3072_page-deity-2.webp";
...
export default function DeityPage({ deityKey }: { deityKey: string }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageIllustrations images={[{ src: deityImg1, alt: "金色佛像局部特寫與燭光散景" }, { src: deityImg2, alt: "供桌儀軌用品俯拍" }]} />
