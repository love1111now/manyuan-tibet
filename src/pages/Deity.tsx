            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              <Link href="/pay">
                <Button className="h-12 px-6 font-black tracking-[0.24em] uppercase gold-border">
                  直接去預定 <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <Link
                href="/puja"
        ...
        <section className="mt-12">
          <div className="flex items-end justify-between gap-6 flex-wrap">
            <div>
              ...
              <p className="mt-2 readable text-muted-foreground">先選最推薦，再依需求升級。不要混走路徑。</p>
            </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      {p.hot ? (
                        <Badge className="gold-border bg-accent/35 text-accent-foreground">最推薦</Badge>
                      ) : null}
                    </div>
                    <div className="mt-2 text-sm text-muted-foreground">點擊按鈕後將跳轉綠界完成付款</div>
                  </div>
                ...
                <div className="mt-6">
                  <a href={p.url} target="_blank" rel="noopener noreferrer">
                    <Button className="h-12 px-6 font-black tracking-[0.22em] uppercase gold-border">
                      去綠界預定 <ExternalLink className="h-4 w-4" />
                    </Button>
                  </a>
                </div>

                <div className="mt-4 text-[11px] text-muted-foreground leading-relaxed">
                  付款完成後，依綠界頁面提示填寫祈願姓名與事項，其餘照流程安排。
                </div>
              </Card>
            ))}
          </div>
