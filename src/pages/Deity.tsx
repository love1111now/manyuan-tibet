...
import { ArrowLeft, ArrowRight, ExternalLink, Flame, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-4 pt-10 pb-8">
          ...
          <div className="mt-4 grid gap-6 md:grid-cols-[1.05fr_.95fr] md:items-end">
            <div>
            ...
            <Card className="gold-border bg-card/70 paper-grain overflow-hidden">
              <img src={d.heroImage} alt={d.name} className="h-60 w-full object-cover" loading="eager" />
              <div className="p-6">
          ...
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-3 readable text-muted-foreground max-w-prose">
                若你不確定，先選「最多人選」那個（已標示）。你也可以先做入門，把狀態穩住。
              </p>
            </div>
          </div>
                ...
                <Card key={p.id} className="p-7 gold-border bg-card/70 paper-grain">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Link href="/pay" className="flex-1">
                      <Button variant="outline" className="h-12 w-full gold-border">看完整登記說明</Button>
                    </Link>
                  </div>
        ...
        <section className="mx-auto max-w-6xl px-4 pt-10 pb-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {d.faq.map((f) => (
              <Card key={f.q} className="p-7 gold-border bg-card/70 paper-grain">
                <div className="font-display text-xl">{f.q}</div>
                <div className="mt-3 readable text-muted-foreground">{f.a}</div>
              </Card>
            ))}
          </div>
        </section>
