...
export const medicineBuddha: Deity = {
  ...
  testimonials: [
    { title: "手術順利，超乎預期的復原", body: "父親被診斷出腫瘤需要緊急手術，全家都陷入愁雲慘霧。我為他登記了藥師佛深層淨化加強方案。奇蹟的是，手術不僅非常成功，醫生還說腫瘤沒有擴散，且術後恢復的速度比年輕人還快。那湛藍色的光芒，真的接住了我們的無助。", by: "新竹市 李小姐 (科技業)" },
    { title: "困擾三年的嚴重失眠不藥而癒", body: "因為長期的工作高壓，我患上了嚴重的失眠與自律神經失調，吃藥也只能睡兩小時。在參與修法後，我試著睡前靜心。某個晚上，我感到一股清涼的能量從頭頂灌入，那天我竟然一覺到天亮。這是我這三年來睡得最安穩的一覺。", by: "台北市 吳先生 (行銷總監)" },
    { title: "減輕了化療過程的巨大痛苦", body: "母親在化療期間非常痛苦，吃不下也睡不好。我只能無助地為她祈求藥師佛。很神奇地，在點燈的隔週，她說那種像被火燒的副作用減輕了很多，甚至能喝下一整碗湯了。這份慈悲的減輕痛苦，對家屬來說就是最大的安慰。", by: "台中市 陳先生 (會計師)" }
  ],
  ...
  painPoints: ["自己或家人面臨嚴重的疾病，需要醫療之外的心靈支持", "長期受慢性病或心理疾病（如失眠、焦慮）折磨", "感受到生命力的流失，希望能為長輩祈求健康延壽"],
  whyThisDeity: ["專司療癒，能拔除生死之病與各種身心疾患", "其十二大願皆為滿足眾生現世的安樂與免於病苦", "能消除過往的惡業，化解導致疾病的深層因果"],
  process: [
    { title: "發心與探索", body: "安頓身心，皈依三寶；帶著對生命的珍視，為自己或生病的親友，生起強烈的求生與療癒渴望。" },
    { title: "相應與轉化", body: "透過修法與點燈，觀想藥師甘露洗滌病灶，讓生機重新注入衰弱的軀體。" },
    { title: "回向與見證", body: "將功德回向給病患；志工將細心造冊，以最溫柔的祈願陪伴您度過健康的關卡。" }
  ],
  plans: [
    { id: "mb-490", name: "平靜微光｜藥師佛安康供燈回向", price: 490, blurb: "為疲憊的身心點亮一盞燈：溫柔撫平失眠與焦慮，祈求日常的健康與平靜。", url: "https://cart.cashier.ecpay.com.tw/qp/m9N1", suitableFor: ["改善失眠焦慮", "日常養生祈福"], details: ["清淨安康供燈", "✦ 本月結緣：每週六藥師佛息災煙供守護"] },
    { id: "mb-980", name: "琉璃療癒｜藥師佛消災延壽相應", price: 980, blurb: "當您或家人面臨病痛折磨：以完整的儀軌相應，減輕醫療過程中的痛苦，祈求早日康復。", url: "https://cart.cashier.ecpay.com.tw/qp/m9O2", hot: true, badge: "療癒首選", suitableFor: ["病患祈福", "長輩延壽"], details: ["專屬延壽相應修法", "康復祈願回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] },
    { id: "mb-1860", name: "拔除疾苦｜藥師佛深層淨化加強", price: 1860, blurb: "面對長期慢性病或重大手術：深度淨化導致疾病的無形業力，為生命注入強大的復甦能量。", url: "https://cart.cashier.ecpay.com.tw/qp/m9P3", suitableFor: ["重大疾病康復", "手術平安祈福"], details: ["深層息災淨業香供", "加強延壽回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] }
  ],
  faq: [
