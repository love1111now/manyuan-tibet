...
export const medicineBuddha: Deity = {
  ...
  painPoints: ["自己或家人面臨嚴重疾病，需要心靈支持", "長期受慢性病或心理疾病（失眠焦慮）折磨", "感受生命力流失，盼為長輩祈求健康延壽"],
  whyThisDeity: ["專司療癒，能拔除生死之病與各種疾患", "其十二大願皆為滿足現世安樂與免於病苦", "能消除過往惡業，化解導致疾病深層因果"],
  process: [
  ...
  plans: [
    { id: "mb-personal", name: "琉璃光境 ｜ 藥師如來健康息災煙供-個人", price: 490, blurb: "為疲憊的身心點亮一盞燈：溫柔撫平病痛與焦慮，祈求個人的健康與平靜。", url: "https://cart.cashier.ecpay.com.tw/qp/z4V8", suitableFor: ["個人養生祈福", "改善失眠焦慮"], details: ["個人專屬息災煙供", "✦ 本月結緣：加強健康防禦護持"] },
    { id: "mb-group", name: "琉璃光境 ｜ 藥師如來健康息災煙供-團體", price: 980, blurb: "當您與家人面臨健康挑戰：以團體共修的強大願力相應，減輕痛苦，祈求全家安康早日康復。", url: "https://cart.cashier.ecpay.com.tw/qp/z4U2", hot: true, badge: "療癒首選", suitableFor: ["家人健康祈福", "長輩病患延壽"], details: ["全家/團體息災煙供", "康復祈願回向", "✦ 本月結緣：加強健康防禦護持"] }
  ],
  faq: [
