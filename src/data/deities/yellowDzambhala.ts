...
繼續讓狀況拖下去，還是今天開始處理。`,
  ...
  testimonials: [
    { 
      title: "收入一直有，但錢就是留不住", 
      body: "每個月都有收入，但月底帳戶總是空的。護持後沒有爆富，但年底竟然調薪了，這反而更真實。", 
      by: "台北・上班族｜#財務增長 (2025.11)" 
    },
    { 
      title: "案子每次都差那最後一步", 
      body: "談了快三個月的客戶，一直卡在簽約前。護持後兩週，對方突然主動回來說要繼續。", 
      by: "台中・業務｜#業績突破 (2026.01)" 
    },
    { 
      title: "半信半疑，但生活開始真的順了", 
      body: "我不是很信這個，但朋友推薦就試試。感覺比補財庫還有用，機會也多了很多。", 
      by: "台南・自由工作者｜#富足心態 (2026.03)" 
    },
    {
      title: "卡了大半年的合作案，突然有進展",
      body: "一個拖了很久的合作案，護持後對方主動找我談，完全沒預期到。",
      by: "新北・營建業｜#卡關突破 (2026.04)"
    }
  ],
  ...
  faq: [
    ...
    { 
      q: "這真的有用嗎？", 
      a: "如果你看到這裡還有共鳴，那份共鳴本身就是最誠實的訊號。如果不作任何事情,狀況會變好嗎?。" 
    },
    {
      q: "我要填什麼資料？",
  ...
  crossSell: [
    {
      title: "作明佛母｜增加客源與貴人",
      to: "kurukulla", 
      desc: "適合沒有客戶來源、需要貴人 ➔ 探索(愛情)引流法門"
    },
    {
      title: "象頭財神｜破除投資阻礙",
      to: "ganapati", 
      desc: "適合投資理財遇到瓶頸的人 ➔ 想要投資穩的住,別賣飛"
    }
  ]
};