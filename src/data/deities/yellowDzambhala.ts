...
export const yellow: Deity = {
  ...
  promise:
    "多數人以為自己賺不到錢，其實問題不只是「收入不夠」，更糟的是「流失」。\n\n你是否有過這些狀況：\n明明有進帳，但總是存不下來？\n案子快成卻臨門失手？\n努力很多，但結果總差一點？\n\n這不是能力問題，而是財富結構出現「漏損」。\n\n黃財神水供，不是幫你憑空變有錢，而是：\n✔ 修復財富容器\n✔ 清理阻塞的機會流\n✔ 讓該來的錢，真正留下來\n\n當流動被打開，你會發現——\n機會開始出現、錢開始留下、決策開始變穩。",
  ...
  precaution: {
    title: "這不只是致富，更需要是結構修復：",
    items: [
      "不要想成投機捷徑，而是徹底調整你與財富之間的關係",
      "修法會移除阻礙，但行動仍需要你親自完成",
  ...
  testimonials: [
    { 
      title: "錢開始留下來，有庫才是關鍵", 
      body: "以前不是沒收入，是存不住。護持後最大改變是——錢真的留得下來，財庫有底氣之後，反而更敢接高價案。", 
      by: "台中・自由接案者" 
    },
    { 
      title: "卡住的單，真的動了", 
  ...
  plans: [
    { 
      ...
      suitableFor: ["焦慮", "小額不斷流失"]
    },
    { 
      id: "y-980", 
      name: "主力方案｜現金流修復（最多人選）", 
      price: 980, 
      blurb: "適合：業績卡關、收入不穩，需要明顯財庫改善的人", 
  ...
  faq: [
    ...
    { 
      q: "我還需要努力嗎？", 
      a: "需要。這個法門是讓你的努力「不再被吃掉」追求擴增放大還有餘裕，而不是讓你躺平。" 
    }
  ],
