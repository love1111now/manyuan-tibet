...
export const yellow: Deity = {
  ...
  painPoints: ["感受資源侷限與事業停滯", "現金流動帶來深層焦慮", "努力付出卻難將豐盛留存"],
  ...
  plans: [
    { id: "y-490", name: "撫平匱乏 ｜ 黃財神微光供燈", price: 490, blurb: "為財富流動點亮一盞燈：溫柔對治內在的匱乏感，讓生命的出口重新展現。", url: "https://cart.cashier.ecpay.com.tw/qp/z4W0", suitableFor: ["初次探索", "尋找財務安定"], details: ["清淨供燈回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] },
    { id: "y-980", name: "啟動豐盛 ｜ 黃財神相應水供", price: 980, blurb: "當您渴望事業的活水：以完整的儀軌相應，引導迷失的資糧重新流向您。", url: "https://cart.cashier.ecpay.com.tw/qp/z4XF", hot: true, badge: "共鳴首選", suitableFor: ["現金流轉圜", "業績突破"], details: ["連續水供相應", "專屬祈願回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] },
    { id: "y-1860", name: "深耕淨障 ｜ 黃財神除障香供", price: 1860, blurb: "當努力總是遭遇無形阻滯：透過深層的清淨轉化，化解阻擋豐盛的違緣。", url: "https://cart.cashier.ecpay.com.tw/qp/z4Y3", suitableFor: ["事業格局擴張", "化解財務風險"], details: ["深層除障香供", "加強守護回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] }
  ],
  faq: [
