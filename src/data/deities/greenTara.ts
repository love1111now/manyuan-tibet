...
export const greenTara: Deity = {
  ...
  painPoints: ["面臨突發的危機、官非或急迫的財務決策關卡", "內心充滿極度的焦慮恐慌，感覺快被壓力壓垮", "長時間祈求的事情（如求子求職）遲遲沒有進展"],
  ...
  plans: [
    ...
    { id: "gt-1280", name: "迅疾滿願 ｜ 綠度母急難救護相應", price: 1280, blurb: "當事情迫在眉睫：祈求度母以最快的速度介入，解除危機，滿足您迫切的願望。", url: "https://cart.cashier.ecpay.com.tw/qp/zED7", hot: true, badge: "急難首選", suitableFor: ["急難救助", "事業求子速滿願"], details: ["專屬迅疾滿願修法", "急難護佑回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] }
  ],
  faq: [
