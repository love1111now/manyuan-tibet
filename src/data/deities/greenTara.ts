...
export const greenTara: Deity = {
  ...
  testimonials: [
    { title: "被卡住的合約，在最後一刻解套", body: "我們公司面臨一個即將違約的生死關頭，如果對方不點頭，資金鏈就會斷裂。在那種恐慌到想吐的狀態下，我求助了綠度母。就在修法登記後的隔天下午，對方主管突然改變主意同意延期。那種『瞬間得救』的感覺，我一輩子都不會忘記。", by: "台北 林先生 ｜ 企業主" },
    { title: "備孕五年的奇蹟生機", body: "做過三次試管都失敗，身心俱疲的我都打算放棄了。在朋友建議下，我向綠度母祈求生機。修法的那段時間，我放下了執念與焦慮，心境變得前所未有的平和。半年後，我竟然自然受孕了。綠度母真的像慈母一樣滿了我的願。", by: "桃園 邱小姐 ｜ 行政人員" },
    { title: "平息了莫名爆發的極度焦慮", body: "有一陣子我深受恐慌症發作之苦，常常覺得自己快喘不過氣來。點了綠度母解憂供燈後，我開始跟著唸綠度母心咒。咒音彷彿有一種神奇的魔力，能瞬間把狂飆的心跳壓下來，讓我感覺到『我安全了』。", by: "台南 吳小姐 ｜ 設計師" }
  ],
  ...
  painPoints: [
    "突如其來的變故（如：失業、官司、意外），讓人措手不及",
    "陷入極度的恐懼與無助，彷彿隨時會墜入失去一切的深淵",
    "生活處於動盪崩塌的邊緣，急需一股強大且迅速的力量介入穩住局面"
  ],
  // 🟢 優化 2: 解法具象化，建立「即刻救援」的系統信任感
  whyThisDeity: [
    "以『迅疾』著稱的慈悲力量，第一時間接住您下墜的失重感",
    "迅速斬斷眼前最迫切的恐懼與障礙，為您爭取喘息與轉圜的空間",
    "溫柔卻堅定地安撫驚嚇的心神，讓您找回面對變局的勇氣與定見"
  ],
  process: [
  ...
  plans: [
    { 
      ...
      name: "平靜微光 ｜ 綠度母解憂供燈回向", 
      price: 680, 
      blurb: "為焦慮的心點亮一盞燈：溫柔釋放緊繃的情緒，祈求在迷茫中看見希望的光。", 
      url: "https://cart.cashier.ecpay.com.tw/qp/zEJ1", 
      suitableFor: ["解除重度焦慮", "日常小願祈福"], 
      // 🟢 優化 3: 加入防禦性標籤，大幅提升 E-E-A-T 權威與清高感
      details: ["清淨解憂供燈", "⚠️ 適用於緊急安頓，後續需依循因果正道解決根本問題", "✦ 本月結緣：每週六藥師佛息災煙供守護"] 
    },
    { 
      id: "gt-1280", 
      name: "迅疾滿願 ｜ 綠度母急難救護相應", 
      price: 1280, 
      blurb: "當事情迫在眉睫：祈求度母以最快的速度介入，解除危機，滿足您迫切的願望。", 
      url: "https://cart.cashier.ecpay.com.tw/qp/zED7", 
      hot: true, 
      badge: "急難首選", 
      suitableFor: ["急難救助", "事業求子速滿願"], 
      details: ["專屬迅疾滿願修法", "急難護佑回向", "⚠️ 適用於緊急安頓，後續需依循因果正道解決根本問題", "✦ 本月結緣：每週六藥師佛息災煙供守護"] 
    }
  ],
  faq: [
  ...
  crossSell: [
    { title: "如果您的急難主要來自於事業競爭或小人陷害", desc: "探索象神：同時啟動強力的除障與反擊能量。", to: "ganapati" },
    { title: "如果您需要溫暖的善緣來解決人際急難", desc: "探索作明佛母：以懷愛的力量化解人際危機。", to: "kurukulla" }
  ]
};