...
export const mahashri: Deity = {
  ...
  painPoints: [
    "家庭氣氛緊繃，成員間爭吵不斷，無法在『家』中感到放鬆與歸屬",
    "搬家、買房或空間磁場混亂，導致全家人的運勢與健康受到牽連",
    "家道中落或面臨財富傳承的危機，急需穩住家族的底層根基"
  ],
  // 🟢 優化 2: 解法具象化，建立「磁場防禦」的系統信任感
  whyThisDeity: [
    "以極致的慈悲與威猛，鎮守家庭與空間的能量地基，防堵家運漏損",
    "轉化家宅中的肅殺與對立磁場，注入和諧、繁榮與溫暖的頻率",
    "守護家族資糧不漏，為您與下一代奠定安穩的福德基礎"
  ],
  process: [
  ...
  plans: [
    ...
    },
    {
      ...
      details: ["深層吉祥香供", "加強福德回向", "⚠️ 需配合自身對家庭關係的耐心經營與善意溝通", "✦ 本月結緣：每週六藥師佛息災煙供守護"]
    }
  ],
  faq: [
  ...
  crossSell: [
    { title: "如果您面臨明顯的事業阻礙需要突破", desc: "探索象神・精靈主：以剛猛之力掃除違緣。", to: "ganapati" },
