...
export const kurukulla: Deity = {
  ...
  painPoints: ["親密關係屢遭挫折，難以建立長久的感情", "職場上雖然努力，卻總是無法獲得主管與同事支持", "渴望擴大人脈或客源，卻不知如何散發親和力"],
  whyThisDeity: ["療癒情感創傷，喚醒內在的自信與溫柔", "強效勾招善緣與正桃花，改善單身或關係冰點", "極大化職場與商場魅力，令見者生歡喜心"],
  process: [
  ...
  plans: [
    { id: "k-490", name: "溫柔微光 ｜ 作明佛母善緣供燈", price: 490, blurb: "為冰凍的關係點亮一盞燈：軟化人際互動的稜角，祈求日常互動中的和諧與善意。", url: "https://cart.cashier.ecpay.com.tw/qp/z5a8", suitableFor: ["改善職場人緣", "化解家庭冷戰"], details: ["清淨懷愛供燈", "✦ 本月結緣：每週六藥師佛息災煙供守護"] },
    { id: "k-980", name: "桃花綻放 ｜ 作明佛母相應修法", price: 980, blurb: "當您準備好迎接新的情感羈絆：以完整的儀軌相應，為生命注入迷人的吸引力與正桃花。", url: "https://cart.cashier.ecpay.com.tw/qp/z5bF", hot: true, badge: "善緣首選", suitableFor: ["單身尋良緣", "感情升溫"], details: ["專屬懷愛相應修法", "良緣祈願回向", "✦ 本月結緣：每週六藥師佛息災煙供守護"] },
    { id: "k-1860", name: "廣大懷愛 ｜ 作明佛母人脈加強", price: 1860, blurb: "專為需要廣大客源與群眾魅力的您設計：將懷愛的能量擴展至事業版圖，令合作方心生歡喜。", url: "https://cart.cashier.ecpay.com.tw/qp/z5c3", suitableFor: ["業務與創作者", "高知名度職業"], details: ["深層懷愛香供", "加強客源勾招", "✦ 本月結緣：每週六藥師佛息災煙供守護"] }
  ],
  faq: [
