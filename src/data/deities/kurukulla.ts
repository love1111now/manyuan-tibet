...
export const kurukulla: Deity = {
  ...
  testimonials: [
    ...
    {
      title: "單身三年，終於遇見頻率相近的對象",
      body: "原本對感情已經隨緣甚至有點放棄，總覺得很難遇到懂我的人。修法後，我開始學會先愛自己，生活狀態變得很好。就在上個月，自然而然地認識了現在的另一半，相處起來完全沒有以前的患得患失，非常踏實溫暖。",
      by: "桃園 李小姐｜室內設計師",
    },
    {
      title: "化解深層矛盾，關係變得更緊密",
      body: "準備結婚的過程中，我們因為壓力產生了前所未有的激烈爭吵，甚至一度想要分開。護持作明佛母法事後，那種莫名急躁和防備的心情神奇地平靜了下來。我們終於能好好坐下來傾聽彼此，現在感情反而比以前更深厚了。",
      by: "台南 郭先生｜工程師",
    },
  ],
  ...
  plans: [
    {
      ...
      details: ["作明佛母供燈"], // ✅ 這裡已經刪除了「每週校對藥師佛煙供回向」
    },
    {
      id: "k-980",
      name: "職場貴人相應修法",
