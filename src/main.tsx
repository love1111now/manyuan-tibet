    ...
    <div className="min-h-screen bg-[#050505] font-sans text-slate-200 selection:bg-amber-500/30 overflow-x-hidden">
      ...
      <main>
        {/* =========================================================
            1. Hero 區塊 
        ========================================================= */}
        <section className="relative pt-32 pb-32 md:pt-48 md:pb-56 px-6">
        ...
        <section className="px-6 relative z-20 -mt-20 md:-mt-28 mb-24">
          <div className="max-w-5xl mx-auto">
            <div className="group relative rounded-[2.5rem] p-[2px] bg-gradient-to-r from-red-700 via-red-500 to-amber-500 overflow-hidden shadow-2xl">
              <div className="bg-[#0A0A0A] rounded-[2.4rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-96 h-96 bg-red-500/10 rounded-full blur-[80px] pointer-events-none" />
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-6 z-10 w-full text-center sm:text-left">
                  <div className="shrink-0 w-20 h-20 rounded-full bg-red-950 border border-red-500/50 flex items-center justify-center text-red-500">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-[#1A1105] border border-amber-500/30 rounded-2xl p-5 inline-block text-left mb-4 w-full">
                      <p className="text-[#D4AF37] text-base font-bold leading-relaxed mb-2">
                        <span className="text-white">即日起至 4/2，凡於官網登記【任一法事】，滿願藏庫即免費送您：</span><br />
                ...
                <div className="flex flex-col gap-4 shrink-0 w-full md:w-auto z-10 self-center md:self-stretch justify-center mt-6 md:mt-0">
                  <Link href="/pay">
                    <Button className="w-full bg-[#D4AF37] hover:bg-amber-400 text-black px-8 h-14 font-bold text-base shadow-lg">
                      立即登記任一法事 <ArrowRight className="w-5 h-5 ml-2" />
                    </Button>
                  </Link>
                  <Button variant="outline" className="w-full border-white/20 text-slate-300 hover:bg-white/10 px-6 h-12 text-sm font-bold cursor-not-allowed opacity-70">
                    了解綠度母火供（4/7開放）
                  </Button>
                </div>
        ...
        <section id="paths" className="py-32 px-6 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
              {CORE_PATHS.map((path) => (
                <Card key={path.id} className="group relative p-8 rounded-3xl border border-white/20 bg-white/[0.03] hover:bg-white/[0.06] hover:border-amber-500/50 transition-all duration-300 flex flex-col h-full">
        ...
        <section className="py-24 bg-white/[0.02] border-y border-white/10">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="mt-16 text-center">
               <Link href="/pay">
                  <Button className="h-16 px-12 bg-white hover:bg-amber-100 text-black font-bold text-lg transition-all">
            ...
            <Card className="p-10 md:p-16 rounded-[3rem] border border-amber-500/30 bg-[#0A0A0A] text-center">
              ...
              <div className="grid sm:grid-cols-3 gap-8 text-left border-t border-white/10 pt-10">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-300 leading-relaxed">24 小時內傳送名單至現場，法會當日如法迴向並提供數位證明。</p>
                </div>
                <div>
